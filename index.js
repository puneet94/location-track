...
//to add fence
require('./controllers/add_fence_controller.js')(app);


require('./controllers/lock_controller.js')(app);


// to add groups
require('./controllers/add_group_controller.js')(app);

require('./controllers/get_imei_controller.js')(app);
...
require('./controllers/device_notification_controller.js')(app);
require('./controllers/initial_notification_controller.js')(app);

require('./controllers/single_log_controller.js')(app);

require('./controllers/profile_controller.js')(app,upload);
var device_status_controller = require('./controllers/device_status_controller');
app.set('port', 8080);
